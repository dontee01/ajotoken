...
contract AjoToken is MintableToken {
    using SafeMath for uint256;

    string public name = "Ajo Token";
    string public symbol = "AJO";
    ...
    // function AjoToken(address _fundsWallet, uint256 initialSupply) {
    function AjoToken(address _fundsWallet) {
        fundsWallet = _fundsWallet;

        // preassign control token
        mint(fundsWallet, 200000);
        // if (initialSupply > 0) {
...
// contract AjoToken is PausableToken {
//     using SafeMath for uint256;
